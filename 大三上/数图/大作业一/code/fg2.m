...
for i=1:rn
    for j=1:cn
        ...
        if size(x,1)==2 
            ...
            if dis<14.5086 && dis>0.708 && (dis<1.5811 || dis>1.5812)%认为是指纹区域
                io=ones(32,32);
                io(x(1),y(1))=0;
                io(x(2),y(2))=0;
...
% Ifilt1=imbinarize(Ifilt1,0.35);
Ifilt1 = imbinarize(Ifilt1,'adaptive','ForegroundPolarity','dark','Sensitivity',0.55);
imshow(Ifilt1);
